...
contract ECVerifyTest {
    function ecverify(bytes32 hash, bytes sig, address signer) returns (bool) {
        bool ret;
        address addr;
        (ret, addr) = ECVerify.ecrecovery(hash, sig);
    ...
    function test_v0() returns (bool) {
        ...
        return ecverify(hash, sig, 0x0e5cb767cce09a7f3ca594df118aa519be5e2b5a);
    }
    ...
    function test_v1() returns (bool) {
        ...
        return ecverify(hash, sig, 0x8743523d96a1b2cbe0c6909653a56da18ed484af);
    }
}